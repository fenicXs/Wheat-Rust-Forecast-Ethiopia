...
The largest absolute improvement is for leaf rust (+0.160 AUC), which was previously near the threshold of meaningful predictability. The largest relative improvement is for stripe rust (+20.2\%), which was near-random under the baseline. Stem rust, which already performed reasonably under the baseline, still improves by +7.9\%.
